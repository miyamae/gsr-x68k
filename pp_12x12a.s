*
* 12x12圧縮フォント文字列表示（半角だけROM標準フォント版）
*
...
.xdef	prs_print_12x12		* １２（６）ドット圧縮文字表示ルーチン
.xdef	make_hankaku_12x12	* 半角圧縮文字の作成
.xdef	COLOR_12x12		* 圧縮表示文字の色
...
prs_print_12x12:			* in d7.L=縦*$80*16
					*    d6.L=横
					*    a6=文字列＋終端コード(0)
...
.even
COLOR_12x12:
	.dc.w	%1_1_0010_0000			* 圧縮文字列の表示色（CRTC_R21のデータ形式）
